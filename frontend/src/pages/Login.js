...
import { AlertCircle, TrendingUp, Mail, Lock } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="space-y-4 text-center">
          ...
          <div>
            <CardTitle className="text-2xl font-bold">Welcome to QSD Pharmalytics</CardTitle>
            <CardDescription className="text-base mt-2">Sign in to continue</CardDescription>
          </div>
        </CardHeader>
